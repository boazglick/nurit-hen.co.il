module.exports = {
  siteUrl: "https://nurit-hen.co.il", // Site domain. Do not include a trailing slash!

  postsPerPage: 12, // Number of posts shown on paginated pages (changes this requires sometimes to delete the cache)

  siteTitleMeta: "nurit-hen", // This allows an alternative site title for meta data for pages.
  siteDescriptionMeta:
    "nurit-hen", // This allows an alternative site description for meta data for pages.

  shareImageWidth: 1000, // Change to the width of your default share image
  shareImageHeight: 523, // Change to the height of your default share image

  shortTitle: "nurit-hen", // Used for App manifest e.g. Mobile Home Screen
  ...
  footer: {
    ...
    navigation: [
      ...
      {
        label: "Sitemap",
        url: "https://nurit-hen.co.il/sitemap.xml",
      },
